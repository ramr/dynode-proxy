 ...
 *
 *  Examples:
 *    var rj = '/etc/httpd/conf.d/dynode-proxy/$uuid_$ns_$app/route.json';
 *    _load_routes(rj);
 *
 ...
 *
 *  Examples:
 *    _get_routing_key('App-NameSpace.provider.com/app/route');
 *       // => 'app-namespace.provider.com/app/route'
 *
 ...
 *  Examples:
 *    var rtab = new ProxyRoutes.ProxyRoutes();
 *    rtab.add('app1-ramr.provider.com', '127.5.1.1:8080');
 *    rtab.add('app2-ramr.provider.com',
 ...
 *    var rtab = new ProxyRoutes.ProxyRoutes();
 *    rtab.load(rj);
 *    rtab.remove('appy-ramr.provider.com');
 *
 *  @param   {Integer|String}  External route name/info (external port or
 *                             virtual host/alias name).
 ...
 *    var rtab = new ProxyRoutes.ProxyRoutes();
 *    rtab.load(rj);
 *    rtab.get('app1-ramr.provider.com');
 *    rtab.get(35753);
 *
 *
 *  @param   {Integer|String}  External route name/info (external port or
 ...
 *    var rtab = new ProxyRoutes.ProxyRoutes();
 *    rtab.load(rj);
 *    rtab.getLimits('app1-ramr.provider.com');
 *
 *
 *  @param   {Integer|String}  External route name/info (external port or
 *                             virtual host/alias name).
 ...
 *    var rtab = new ProxyRoutes.ProxyRoutes();
 *    rtab.load(rj);
 *    rtab.getConnectionLimit('app1-ramr.provider.com');
 *
 *
 *  @param   {Integer|String}  External route name/info (external port or
 *                             virtual host/alias name).
 ...
 *    var rtab = new ProxyRoutes.ProxyRoutes();
 *    rtab.load(rj);
 *    rtab.getBandwidthLimits('app1-ramr.provider.com');
 *
 *
 *  @param   {Integer|String}  External route name/info (external port or
 *                             virtual host/alias name).
