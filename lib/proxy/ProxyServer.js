 ...
 *
 *  Examples:
 *    _load_config('/etc/dynode-proxy/web-proxy.json');
 *
 ...
 *      _setProxyResponseHeaders(pres, 'app1-ramr.provider.com', 60);
 *    });
 *
 ...
 *    var cfgfile      = '/etc/dynode-proxy/web-proxy.json';
 ...
 *    var proxy_server = new ProxyServer.ProxyServer(cfgfile);
 *    proxy_server.initServer();
 *    proxy_server.getRoute('app1-ramr.provider.com');
